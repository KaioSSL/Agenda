        ...
        <div class = "boxCentro">
            ...
            <div class="boxConteudo">
                ...
                <div class="boxForm">
					...
					<form name="cadastroCompromisso" action="../php/alterarCompromisso.php">
                        <input type="hidden" name="id" value="<?php echo $_REQUEST['id']?>">
                        <spam>Data:</spam> <input type="date" name="data" value="<?php echo $_data; ?>" required><br>
						<spam>Hora:</spam> <input type="time" name="hora" maxlength="14" value="<?php echo $_hora; ?>" required><br>
						<spam>Assunto:</spam><input type="text" name="assunto" value="<?php echo $_assunto; ?>" required><Br>
